...
const fullName= "Mustafa Mustafa";
...
console.log("My name is Mustafa Mustafa, and I think 7 is a winner!");
...
if (pets < allowedPets ) {console.log("I can have more pets");
  ...
  } else {console.log("I have too many pets! ");
...
{console.log('I have enough pets');} if (pets == allowedPets)
